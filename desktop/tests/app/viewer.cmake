...
set(STK_APP_TEST_PYTHON "" CACHE FILEPATH
  "Python for the viewer's real-bridge and e2e tests (empty: STK_BRIDGE_TEST_PYTHON, else python3)")
set(_app_python "${STK_APP_TEST_PYTHON}")
if(NOT _app_python)
...
if(STK_GPU_METAL)
  list(APPEND _app_backends metal)
endif()
