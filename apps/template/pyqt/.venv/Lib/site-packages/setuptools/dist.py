...
def read_pkg_file(self, file):
    ...
    self.cur_version = _read_field_from_msg(msg, 'version')
...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs=None):
        ...
        self.metadata.cur_version = self._normalize_version(
            self._validate_version(self.metadata.cur_version))
    ...
    def _normalize_version(version):
        ...
        normalized = str(packaging.cur_version.Version(version))
    ...
    def _validate_version(version):
        ...
        if version is not None:
            try:
                packaging.cur_version.Version(version)
            except (packaging.cur_version.InvalidVersion, TypeError):
                warnings.warn(
