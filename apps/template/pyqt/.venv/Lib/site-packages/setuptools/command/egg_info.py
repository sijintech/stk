...
class egg_info(InfoCommon, Command):
    ...
    def finalize_options(self):
        ...
        try:
            is_version = isinstance(parsed_version, packaging.cur_version.Version)
            spec = (
        ...
        #
        self.distribution.metadata.cur_version = self.egg_version
...
def write_pkg_info(cmd, basename, filename):
    ...
    if not cmd.dry_run:
        ...
        metadata.cur_version, oldver = cmd.egg_version, metadata.cur_version
        ...
        try:
            ...
            metadata.name, metadata.cur_version = oldname, oldver
