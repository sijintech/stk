...
@pytest.mark.parametrize("mutate, message", [
    ...
    (lambda m: m["layers"][2]["transfer_function"].update(opacity=[[0.0, 2.0], [1.0, 0.5]]), "alpha in"),
    (lambda m: m["layers"][2]["transfer_function"].update(opacity="ramp"), "at least two"),
    (lambda m: m["layers"][2]["transfer_function"].update(opacity=[[0.0, 0.5]]), "at least two"),
    ...
    (lambda m: m["layers"][0]["attributes"].update(height="accessor"), "attribute must be an object"),
    (lambda m: m["layers"][1].update(glyph="arrow"), "glyph must be an object"),
    (lambda m: m["layers"][0]["appearance"].update(color="red"), "colour spec must be an object"),
    (lambda m: m["layers"][0].update(appearance=0), "appearance must be an object"),
