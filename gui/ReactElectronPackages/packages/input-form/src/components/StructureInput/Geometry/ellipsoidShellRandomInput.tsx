...
import type { EllipsoidShellRandomInputData } from "@mupro/typings/GeometryInput";

class EllipsoidShellRandomInput extends React.Component<
  GeometryInputProps,
  {}
> {
  onImport = (geometry: EllipsoidShellRandomInputData) => {
    if (!this.props.formRef.current) return;
    let i = this.props.index;
    console.log("onImport from the EllipsoidShellRandom", i, geometry);
  ...
  onFinish = (values: any): EllipsoidShellRandomInputData => {
    let i = this.props.index;
    console.log("onFinish from the EllipsoidShellRandom", i, values);
    return {
    ...
    return (
      <div>
        <Form.Item label="Count">
          <Tooltip
            title="The amount of ellipsoid shell to be created."
...
export { EllipsoidShellRandomInput };
